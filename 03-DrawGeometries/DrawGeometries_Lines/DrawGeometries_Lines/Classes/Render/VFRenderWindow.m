...
- (void)prepareVertexDatas {
    ...
    [self.vertexManager setDrawGeometry:VFDrawGeometryType_BezierMountain];
...
#pragma mark - Reset Render Context

- (void)resetRenderContext {
    
    [self.renderContext resetContext];
